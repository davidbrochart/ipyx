...
# -*- coding: utf-8 -*-
#
# ipyx documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyx', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyx.tex', 'ipyx Documentation',
